# Configuration for the U-MV-Base Model

_base_ = [
    '../_base_/datasets/uav_acacia_dataset.py', # Using your custom dataset config for consistency
...
optimizer = dict(type='AdamW', lr=0.0001, weight_decay=0.05, betas=(0.9, 0.999), eps=1e-8)
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=optimizer,
