...
# 8-bit RGB project.  For multispectral data see tutorial/examples/lulc_multispectral.
custom_imports = dict(imports=['umv'], allow_failed_imports=False)

# ---- EDIT 1: where the tiles are (inside the container: /data/<project>)
data_root = '/data'   # the hand-over dataset mounted at /data
...
crop_size = (1024, 1024)   # as in the paper (crown ~5 m at 2.5 cm GSD needs context)
